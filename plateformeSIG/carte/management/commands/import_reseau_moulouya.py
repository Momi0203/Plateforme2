"""
Commande : python manage.py import_reseau_moulouya [--replace]

Module INDÉPENDANT d'import du réseau hydrographique « ouvrage de tête » du
bassin Moulouya, lu depuis :
  plateformeSIG/plateformeSIG/static/resaux hydrographique ouvrage en tete/moulouya.shp

Insère les tronçons (LineString) dans le modèle carte.ReseauOuvrageTeteMoulouya.
...
from carte.models import ReseauOuvrageTeteMoulouya
...
MODELE        = ReseauOuvrageTeteMoulouya
SHP_CANDIDATS = ["moulouya", "Moulouya"]   # noms de fichier .shp essayés, dans l'ordre
...
class Command(BaseCommand):
    help = "Importe le réseau hydrographique (ouvrage de tête) du bassin Moulouya."
