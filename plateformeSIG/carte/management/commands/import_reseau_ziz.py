"""
Commande : python manage.py import_reseau_ziz [--replace]

Module INDÉPENDANT d'import du réseau hydrographique « ouvrage de tête » du
bassin Ziz, lu depuis :
  plateformeSIG/plateformeSIG/static/resaux hydrographique ouvrage en tete/ziz.shp

Insère les tronçons (LineString) dans le modèle carte.ReseauOuvrageTeteZiz.
...
from carte.models import ReseauOuvrageTeteZiz
...
MODELE        = ReseauOuvrageTeteZiz
SHP_CANDIDATS = ["ziz", "Ziz"]   # noms de fichier .shp essayés, dans l'ordre
...
class Command(BaseCommand):
    help = "Importe le réseau hydrographique (ouvrage de tête) du bassin Ziz."
